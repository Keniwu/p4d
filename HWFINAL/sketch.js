...
function draw() 
{
    ...
    for(var i = 0; i < 8; i++)
  {
    ...
    if (SunObject.s >= 400)
    {
         ...
         background(62,58,64);
         textSize(60);
         text("YOU  LOSE",215,300);
         fill(239,160,127);
         rect(275, 380, 200, 50, 20);
         fill(250,250,250,200);
         textSize(30);
         text("restart",329,415);
         fill(239,160,127,150);
         textSize(20);
         text("press 'r' to restart at any time",235,470);
        
        // when click the restart button, restart all things
        if(mouseX>275 && mouseX<475 && mouseY>380 && mouseY<430 && mouseIsPressed && mouseButton==LEFT )  
    { 
